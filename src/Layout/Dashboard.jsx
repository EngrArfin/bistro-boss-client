      ...
      <div className="drawer-side bg-[#D1A054] ">
        ...
        <ul className="menu p-4 w-80  ">
          ...
          isAdmin ? <>
              ...
              <li><NavLink to="/dashboard/allusers"> <FaUsers></FaUsers> All Users</NavLink></li>
              <li><NavLink to="/dashboard/allusers"><FaCalendarAlt></FaCalendarAlt>Reservation</NavLink></li> {/* /dashboard/reservation */}
              <li><NavLink to="/dashboard/allusers"><FaWallet></FaWallet>Payment History</NavLink></li> {/* /dashboard/history */}
              <li>
          ...
          <li><NavLink to="/secret"><FaHome></FaHome> Secret</NavLink></li>
