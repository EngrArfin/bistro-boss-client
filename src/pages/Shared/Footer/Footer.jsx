import photo1 from '../../../assets/icon/logo.png'
  ...
  return (
    <div className="  ">
      ...
      <footer className="footer p-3 bg-sky-200 mt-3 ">
          ...
          <a className="link link-hover">Boss Restaurants</a>
          <a className="link link-hover">FOOD</a>
          <a className="link link-hover">BD Food Learn</a>
          <a className="link link-hover">English Food</a>
          </div>
          <div>
